...
export default function QuestionGuidance({ question }: QuestionGuidanceProps) {
      ...
      {question.nonConformanceExamples && (
        <Collapsible open={isExamplesOpen} onOpenChange={setIsExamplesOpen}>
          <CollapsibleTrigger asChild>
            <Button 
              variant="outline" 
              className="w-full justify-between hover:bg-red-50"
            >
              <div className="flex items-center space-x-2">
      ...
      {question.auditTips && question.auditTips.length > 0 && (
        <Collapsible open={isTipsOpen} onOpenChange={setIsTipsOpen}>
          <CollapsibleTrigger asChild>
            <Button 
              variant="outline" 
              className="w-full justify-between hover:bg-yellow-50"
            >
              <div className="flex items-center space-x-2">
